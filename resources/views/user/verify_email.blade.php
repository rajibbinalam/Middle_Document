        ...
        <div class="row">
            ...
            <div class="spanu9">
                ...
                @include('error.message')
                    <form class="form-horizontal" method="post" action="{{route('user.verify.email')}}">
                        @csrf
                        ...
                        <div class="control-group">
                            <div class="controls">
                                ...
                                <button type="submit" class="btn btn-large btn-success" type="submit" >Verify Email</button>
                            </div>
                        </div>
                    </form>
                </div>
