              ...
              <tr class="mt-5">
                ...
                <td>
                  <div class="active-listing">
                    ...
                    <p><i class="icon-user"></i>{{$row['color']}}</p>
                ...
                <td style="float: left;">
                  <div class="sec-center" style="margin-top: 150px; margin-left: -100px;">
                    ...
                    <label class="for-dropdown" for="dropdown{{$row->id}}" style="position: absolute; top: -37px;">
                      <i class="icon-cog"></i><i class="uil uil-arrow-down"></i>
                    </label>
                    <div class="section-dropdown" style="width: 169px;top: 50px;">
                      <a href="{{ route('user.active.advertising.view',$row->id) }}" class="dm">View Advertising <i class="uil uil-arrow-right"></i></a>
