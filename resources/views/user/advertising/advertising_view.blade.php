                ...
                <table class="table table-bordered">
                  <tbody>
                    ...
                    <tr class="techSpecRow">
                      ...
                      <td class="techSpecTD2">{{$advertising ->name}}</td>
                    </tr>
                    <tr class="techSpecRow">
                      <td class="techSpecTD1">Category: </td>
                      <td class="techSpecTD2">{{$category ->cat_name}}</td>
                    </tr>
                    <tr class="techSpecRow">
                      <td class="techSpecTD1">SubCategory: </td>
                      <td class="techSpecTD2">{{$sub_category->subcat_name}}</td>
                    </tr>
                    <tr class="techSpecRow">
                      <td class="techSpecTD1">City: </td>
                      <td class="techSpecTD2">{{$city ->city_name}}</td>
                    </tr>
                    <tr class="techSpecRow">
                      <td class="techSpecTD1">Suburb:</td>
                      <td class="techSpecTD2">{{$suburb->suburbs_name}}</td>
                    </tr>

                    <tr class="techSpecRow">
                      <td class="techSpecTD1">Airconditioning :</td>
                      <td class="techSpecTD2">{{$advertising->airconditioning}}</td>
                    </tr>
                    <tr class="techSpecRow">
                      <td class="techSpecTD1">Doors :</td>
                      <td class="techSpecTD2">{{$advertising->door}}</td>
                    </tr>
                    <tr class="techSpecRow">
                      <td class="techSpecTD1">Transmissions :</td>
                      <td class="techSpecTD2">{{$advertising->transmissions}}</td>
                    </tr>
                    <tr class="techSpecRow">
                      <td class="techSpecTD1">Color :</td>
                      <td class="techSpecTD2">{{$advertising->color}}</td>
                    </tr>
                    <tr class="techSpecRow">
                      <td class="techSpecTD1">Body Style:</td>
                      <td class="techSpecTD2">{{$advertising->body}}</td>
                    </tr>
                    <tr class="techSpecRow">
                      <td class="techSpecTD1">Condition :</td>
                      <td class="techSpecTD2">{{$advertising->condition}}</td>
                    </tr>
                    <tr class="techSpecRow">
                      <td class="techSpecTD1">Seller Type :</td>
                      <td class="techSpecTD2">{{$advertising->seller_type}}</td>
                    </tr>
                    <tr class="techSpecRow">
                      <td class="techSpecTD1">Registered :</td>
                      <td class="techSpecTD2">{{$advertising->registered}}</td>
                    </tr>
                    <tr class="techSpecRow">
                      <td class="techSpecTD1">Registration Experiy :</td>
                      <td class="techSpecTD2">{{$advertising->registered_experiy}}</td>
                    </tr>
                    <tr class="techSpecRow">
                      <td class="techSpecTD1">Email :</td>
                      <td class="techSpecTD2">{{$advertising->email}}</td>
                    </tr>
                    <tr class="techSpecRow">
                      <td class="techSpecTD1">Phone :</td>
                      <td class="techSpecTD2">{{$advertising-> phone}}</td>
                    </tr>
                  </tbody>
                </table>
