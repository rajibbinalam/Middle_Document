...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    @include('admin.modal.sub_category.create')
    <!--end::Subheader-->
    <!--begin::Entry-->
        ...
        <div class="card-body">
            ...
            <table class="table table-separate table-head-custom table-checkable" id="kt_datatable1">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$loop->index+1}}</td>
                        <td>@if(!empty($category->id)){{$category->cat_name}} @else @endif</td>
                        ...
                        <td><input type="checkbox" {{$row->status=='1'? 'checked':''}} id="subcategoryStatus"
