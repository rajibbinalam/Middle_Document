...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
  ...
  <ul class="list-group list-group-flush">
      ...
      @php
                            ...
                            @endphp
    <li class="list-group-item">{{$loop->index+1}} -{{$row->suburbs_name}}  - &nbsp;&nbsp;<a href="javascript:void(0)" data-toggle="modal" data-target="#editModal{{$row->id}}">Edit</a>
