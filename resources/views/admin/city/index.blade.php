...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <!-- //add modal -->
    @include('admin.modal.city.create')
            ...
            <table class="table table-separate table-head-custom table-checkable" id="kt_datatable1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{route('admin.city.suburbs.view',$row->id)}}">view and Add</a></td>
                        <td><input type="checkbox" {{$row->status=='1'? 'checked':''}} id="cityStatus"
                        ...
                        <td>
                            ...
                            <a href="javascript:void(0)" class="confirmDelete " record="city"
