<div class="modal fade" id="editModalslider{{$rowslider->id}}" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="post" action="{{route('admin.category.slider.update',$rowslider->id)}}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-12">
                                                <input type="text" class="form-control" name="banner_name"
                                                    value="{{$rowslider->banner_name}}" />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-form-label text-right col-lg-3 col-sm-12">Banner Image</label>
                                            <div class="col-lg-9 col-md-9 col-sm-12">
                                                <input type="file" class="form-control" name="worm_1_image"
                                                    value="{{$rowslider->worm_1_image}}" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <input type="date" class="form-control" name="worm_1_expired"
                                                    value="{{$rowslider->worm_1_expired}}" />
                                            </div>
                                        </div>
