            ...
            <div class="card-title">
                ...
                <form method="get" route="?">
                    ...
                    <div class="form-group col-md-2">
                            <button value="" class=" btn btn-secondary form-control">Id</button>
                        ...
                        <div class="form-group col-md-2">
                            <button value="" class=" btn btn-secondary form-control">User Name</button>
            ...
            <table class="table table-separate table-head-custom table-checkable" id="kt_datatable1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Tax</td>
                        <td>
                            @foreach($row['adsid'] as $addPage)
                            @php
                            $page = App\Models\SiteFees::find($addPage->page_id);


                            $pageName = App\Models\Page::where('id',$page->page_id)->get();
