...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <span class="text-muted font-weight-bold mr-4">Staff</span>
    ...
    <!-- //add modal -->
    @include('admin.modal.staff.create')
            ...
            <table class="table table-separate table-head-custom table-checkable" id="kt_datatable1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$row->email}}</td>
                        <td>{{$row->username}}</td>
                        <td>@if(!empty($role)){{$role->name}} @else @endif</td>
                        ...
                        <td style="width: 100px; float: right;">
                            ...
                            <a href="javascript:void(0)" class="confirmDelete" record="staff" recordid="{{ $row->id }}">
                                <i class="fa fa-trash"></i>
                            </a>
                            
                        </td>
                    </tr>
                    @include('admin.modal.staff.edit')
                    @endforeach
