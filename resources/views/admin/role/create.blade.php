                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width: 100px; float: right;">
                            <a href="{{route('admin.role.edit',$row->id)}}"><i class="fas fa-edit"></i></a>
                            <a href="javascript:void(0)" class="confirmDelete" record="roll" recordid="{{ $row->id }}">
                                <i class="fa fa-trash"></i>
                            </a>
                            <a href="{{route('role.permission',$row->id)}}" >
                                permission
                            </a>
                        </td>
                    </tr>
