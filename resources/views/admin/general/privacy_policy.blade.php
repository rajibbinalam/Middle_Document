                                                ...
                                                <pre style="height:400px">
                                                    ...
                                                    <label class="col-form-label text-right col-lg-3 col-sm-12">Meta Information</label>
														<div class="col-lg-9 col-md-9 col-sm-12">
															<textarea type="text" class="form-control" name="p_p_information" rows="10" cols="50">{{$gs->p_p_information}}</textarea>
                                                    ...
                                                    <div class="form-group row">
														...
														<div class="col-lg-9 col-md-9 col-sm-12">
															<input type="text" class="form-control" name="p_p_title" value="{{$gs->p_p_title}}" />															
														</div>
													</div>
                                                    ...
                                                    <div class="form-group row">
														...
														<div class="col-lg-9 col-md-9 col-sm-12">
															<textarea type="text" class="form-control" name="p_p_description"  rows="10" cols="50">{{$gs->p_p_description}}</textarea>
                                                    ...
                                                    <div class="form-group row">
														...
														<div class="col-lg-9 col-md-9 col-sm-12">
															@php 
															$js = json_decode($gs->p_p_keyword);
															@endphp
															<textarea type="text" class="form-control" name="p_p_keyword[]">@foreach($js as $item) {{$item}} @endforeach</textarea>
