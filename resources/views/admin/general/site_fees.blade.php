            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom example example-compact">
                        ...
                        <!--begin::Form-->
                        <form class="form" method="post" action="{{route('admin.general.privacy_policy')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <!--begin: Code-->
                                                ...
                                                <pre style="height:400px">
                                                    ...
                                                    <label class="col-form-label text-right col-lg-3 col-sm-12">Meta Information</label>
														<div class="col-lg-9 col-md-9 col-sm-12">
															<textarea type="text" class="form-control" name="site_fees_information" rows="10" cols="50">{{$gs->site_fees_information}}</textarea>
                                                    ...
                                                    <div class="form-group row">
														...
														<div class="col-lg-9 col-md-9 col-sm-12">
															<input type="text" class="form-control" name="site_fees_title" value="{{$gs->site_fees_title}}" />															
														</div>
													</div>
                                                    ...
                                                    <div class="form-group row">
														...
														<div class="col-lg-9 col-md-9 col-sm-12">
															<textarea type="text" class="form-control" name="site_fees_description"  rows="10" cols="50">{{$gs->site_fees_description}}</textarea>
                                                    ...
                                                    <div class="form-group row">
														...
														<div class="col-lg-9 col-md-9 col-sm-12">
															@php 
															$js = json_decode($gs->site_fees_keyword);
															@endphp
															<textarea type="text" class="form-control" name="site_fees_keyword[]">@foreach($js as $item) {{$item}} @endforeach</textarea>
