            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom example example-compact">
                        ...
                        <!--begin::Form-->
                        <form class="form" method="post" action="{{route('admin.general.about_us')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <!--begin: Code-->
                                                ...
                                                <pre style="height:400px">
                                                    ...
                                                    <label class="col-form-label text-right col-lg-3 col-sm-12">Meta Information</label>
														<div class="col-lg-9 col-md-9 col-sm-12">
															<textarea type="text" class="form-control" name="a_u_information" rows="10" cols="50">{{$gs->a_u_information}}</textarea>
                                                    ...
                                                    <div class="form-group row">
														...
														<div class="col-lg-9 col-md-9 col-sm-12">
															<input type="text" class="form-control" name="a_u_title" value="{{$gs->a_u_title}}" />															
														</div>
													</div>
                                                    ...
                                                    <div class="form-group row">
														...
														<div class="col-lg-9 col-md-9 col-sm-12">
															<textarea type="text" class="form-control" name="a_u_description"  rows="10" cols="50">{{$gs->a_u_description}}</textarea>
                                                    ...
                                                    <div class="form-group row">
														@php 
														 $tercondintion = json_decode($gs->a_u_keyword);
														@endphp
														<label class="col-form-label text-right col-lg-3 col-sm-12">Meta Keywords</label>
														<div class="col-lg-9 col-md-9 col-sm-12">
															<textarea type="text" class="form-control" name="a_u_keyword[]">@foreach($tercondintion as $item) {{$item}} @endforeach</textarea>
