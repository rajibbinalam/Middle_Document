...
<head>
	...
	<link href="{{asset('assets/backend')}}/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />
	...
	<link href="{{asset('assets/backend')}}/assets/css/themes/layout/style.css" rel="stylesheet" type="text/css" />
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
	...
	<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
		<!--begin::Logo-->
		<a href="index.html">
			<img alt="Logo" src="{{asset('assets/images/setting/'.$gs->site_logo)}}" />
		</a>
		<!--end::Logo-->
		<!--begin::Toolbar-->
						...
						<div class="topbar">
							...
							<div class="topbar-item">
								<div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
									...
									<span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">{{Auth::guard('admin')->user()->f_name}}</span>
				...
				<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
					...
					<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
						...
						<div class="text-dark order-2 order-md-1">
							...
							<a href="https://essential-infotech.com/" target="_blank" class="text-dark-75 text-hover-primary">Essential-infotech</a>
						</div>
						<!--end::Copyright-->
						<!--begin::Nav-->
	...
	<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
		...
		<div class="offcanvas-content pr-5 mr-n5">
			...
			<div class="navi navi-spacer-x-0 p-0">
				<!--begin::Item-->
				<a href="{{route('admin.account')}}" class="navi-item">
					<div class="navi-link">
				...
				<!--end:Item-->
				<!--begin::Item-->
				<a href="{{route('admin.admin.setting')}}" class="navi-item">
					<div class="navi-link">
						<div class="symbol symbol-40 bg-light mr-3">
							<div class="symbol-label">
	...
	<script src="{{asset('assets/backend')}}/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js"></script>
	<!--end::Page Vendors-->
	<!--begin::Page Scripts(used by this page)-->
	<script src="{{asset('assets/backend')}}/assets/js/pages/crud/file-upload/dropzonejs.js"></script>
	<script src="{{asset('assets/backend')}}/assets/js/pages/widgets.js"></script>
	<script src="{{asset('assets/backend')}}/assets/js/pages/custom/profile/profile.js"></script>
	<script src="{{asset('assets/backend')}}/assets/js/pages/crud/file-upload/image-input.js"></script>
	<script src="{{asset('assets/backend')}}/assets/js/pages/crud/forms/widgets/bootstrap-select.js"></script>
	<script src="{{asset('assets/backend')}}/assets/js/pages/crud/forms/widgets/select2.js"></script>
	<script src="{{asset('assets/backend')}}/assets/plugins/custom/datatables/datatables.bundle.js"></script>
	<script src="{{asset('assets/backend')}}/assets/js/pages/crud/datatables/basic/scrollable.js"></script>
	<script src="{{asset('assets/backend')}}/assets/index.js"></script>

	<script src="{{asset('assets/backend')}}/assets/js/pages/crud/forms/widgets/bootstrap-datepicker.js"></script>
	<script src="{{asset('assets/backend')}}/assets/js/pages/crud/forms/editors/summernote.js"></script>
